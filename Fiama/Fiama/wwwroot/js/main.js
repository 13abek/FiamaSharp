...
(function($) {
  "use strict";
    ...
    //Basket
        ...
        $('body').on('click', ".mini-cart-img .remove-header-basket",function (e) {
            e.preventDefault();
            $.ajax({
                url: $(this).attr("href"),
                type: "get",
    ...
    //elem.parent().parent().remove();
                    //$(".mini-cart-icon .mini-cart-icon .ltn__utilize-toggle .mini-cart-icon .headers-basket-count").text(res.count);
                    //$(".mini-cart-footer .mini-cart-sub-total .TotalPrice").text(res.total + "₼");